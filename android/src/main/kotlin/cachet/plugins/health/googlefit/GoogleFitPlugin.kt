// GOOGLE FIT TEMPORARY SUPPORT - REMOVE THIS ENTIRE FILE START -------------------
// This native implementation exists only while Google Fit and Health Connect are
// supported in parallel. Delete the entire file when Google Fit is retired.

package cachet.plugins.health.googlefit
...
const val GOOGLE_FIT_CHANNEL_NAME = "flutter_health/google_fit"
const val MMOLL_2_MGDL = 18.0 // 1 mmoll= 18 mgdl

// The minimum android level that can use Health Connect
const val MIN_SUPPORTED_SDK = Build.VERSION_CODES.O_MR1

class GoogleFitPlugin:
    MethodCallHandler,
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, GOOGLE_FIT_CHANNEL_NAME)
...
// GOOGLE FIT TEMPORARY SUPPORT - REMOVE THIS ENTIRE FILE END ---------------------
